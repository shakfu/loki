/* highlight_scheme.h -- Tree-sitter based Scheme syntax highlighting for linenoise
 *
 * This module provides a syntax highlighting callback that uses tree-sitter
 * to parse Scheme code and colorize it according to the highlights.scm queries.
 */
