/* highlight_chuck.h -- Tree-sitter based ChucK syntax highlighting for linenoise
 *
 * This module provides a syntax highlighting callback that uses tree-sitter
 * to parse ChucK code and colorize it according to the highlights.scm queries.
 */

#ifndef HIGHLIGHT_CHUCK_H
#define HIGHLIGHT_CHUCK_H

#include <stddef.h>

/* Initialize the ChucK highlighter.
 * Must be called before using chuck_highlight_callback.
 * Returns 0 on success, -1 on failure. */
int chuck_highlight_init(void);

/* Free resources used by the ChucK highlighter.
