/* highlight_python.h -- Tree-sitter based Python syntax highlighting for linenoise
 *
 * This module provides a syntax highlighting callback that uses tree-sitter
 * to parse Python code and colorize it according to the highlights.scm queries.
 */

#ifndef HIGHLIGHT_PYTHON_H
#define HIGHLIGHT_PYTHON_H

#include <stddef.h>

/* Initialize the Python highlighter.
 * Must be called before using python_highlight_callback.
 * Returns 0 on success, -1 on failure. */
int python_highlight_init(void);

/* Free resources used by the Python highlighter.
