/* highlight_forth.h -- Tree-sitter based Forth syntax highlighting for linenoise
 *
 * This module provides a syntax highlighting callback that uses tree-sitter
 * to parse Forth code and colorize it according to the highlights.scm queries.
 */

#ifndef HIGHLIGHT_FORTH_H
#define HIGHLIGHT_FORTH_H

#include <stddef.h>

/* Initialize the Forth highlighter.
 * Must be called before using forth_highlight_callback.
 * Returns 0 on success, -1 on failure. */
int forth_highlight_init(void);

/* Free resources used by the Forth highlighter.
